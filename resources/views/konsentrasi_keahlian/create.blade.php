...
<div class="container">
    ...
    <form action="{{ route('konsentrasi_keahlian.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="id_program_keahlian" name="id_program_keahlian" required>
                ...
                @foreach($program_keahlians as $program)
                    <option value="{{ $program->id_program_keahlian }}" {{ old('id_program_keahlian') == $program->id_program_keahlian ? 'selected' : '' }}>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="kode_konsentrasi_keahlian" name="kode_konsentrasi_keahlian" value="{{ old('kode_konsentrasi_keahlian') }}" required maxlength="10">
        </div>
        <div class="form-group">
            <label for="konsentrasi_keahlian">Konsentrasi Keahlian</label>
            <input type="text" class="form-control" id="konsentrasi_keahlian" name="konsentrasi_keahlian" value="{{ old('konsentrasi_keahlian') }}" required maxlength="100">
        </div>
