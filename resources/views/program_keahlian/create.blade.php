...
<div class="container">
    ...
    <form action="{{ route('program_keahlian.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="id_bidang_keahlian" name="id_bidang_keahlian" required>
                ...
                @foreach($bidang_keahlians as $bidang)
                    <option value="{{ $bidang->id_bidang_keahlian }}" {{ old('id_bidang_keahlian') == $bidang->id_bidang_keahlian ? 'selected' : '' }}>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="kode_program_keahlian" name="kode_program_keahlian" value="{{ old('kode_program_keahlian') }}" required maxlength="10">
        </div>
        <div class="form-group">
            <label for="program_keahlian">Program Keahlian</label>
            <input type="text" class="form-control" id="program_keahlian" name="program_keahlian" value="{{ old('program_keahlian') }}" required maxlength="100">
        </div>
